...
execute_process(
  COMMAND "/usr/bin/git" show-ref 4c4b580
  WORKING_DIRECTORY "/home/bento/trusted-firmware-m/tfm/build/lib/ext/tfm_test_repo-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/4c4b580")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "4c4b580")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 4c4b580
  WORKING_DIRECTORY "/home/bento/trusted-firmware-m/tfm/build/lib/ext/tfm_test_repo-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://git.trustedfirmware.org/TF-M/tf-m-tests.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/bento/trusted-firmware-m/tfm/build/lib/ext/tfm_test_repo-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/bento/trusted-firmware-m/tfm/build/lib/ext/tfm_test_repo-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
