...
#define TFM_SP_EXAMPLE_NDEPS                                    (2)
#define TFM_SP_EXAMPLE_NSERVS                                   (1)
#if TFM_LVL == 3
#define TFM_SP_EXAMPLE_NASSETS                                  (0 + 1)
#else
#define TFM_SP_EXAMPLE_NASSETS                                  (0)
#endif
#define TFM_SP_EXAMPLE_NIRQS                                    (0)
...
extern psa_status_t tfm_example_partition_init(void);
...
const struct partition_tfm_sp_example_load_info_t tfm_sp_example_load
    ...
    .load_info = {
        ...
        .entry                      = ENTRY_TO_POSITION(tfm_example_partition_init),
        .stack_size                 = 0x200,
        .heap_size                  = 0,
    ...
    .services = {
        {
            ...
            .sfn                    = ENTRY_TO_POSITION(tfm_example_service_sfn),
            .signal                 = 1,
    ...
    .assets                         = {
        {
            .mem.start              = PART_REGION_ADDR(PT_TFM_SP_EXAMPLE_PRIVATE, _DATA_START$$Base),
            .mem.limit              = PART_REGION_ADDR(PT_TFM_SP_EXAMPLE_PRIVATE, _DATA_END$$Base),
